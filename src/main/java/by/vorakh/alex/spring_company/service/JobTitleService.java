...
@Service
public class JobTitleService implements 
        ServiceInterface<JobTitleViewModel, JobTitlePayload> {
    @Autowired
    ...
    public IdViewModel create(JobTitlePayload newPayload) {
        ...
        try {
            int createdID = jobTitleDAO.create(createdJobTitle);
            return new IdViewModel(createdID);
        } catch (EntityExistsException e) {
            throw new ServiceException("The \"" + createdJobTitle + "\" cannot " 
    ...
    public JobTitle getOrCreateAndGetWithId(JobTitle newJobTitle) {
        if (jobTitleDAO.isContained(newJobTitle)) {
            ...
            try { 
                ...
                throw new ServiceException("The \"" + newJobTitle + "\" cannot" 
                        + " be created, because to exist in database.", e);
            } catch (IllegalArgumentException ex) {
    ...
    public void update(JobTitlePayload editedPayload) {
        if (jobTitleDAO.isContained(editedPayload.getTitle())) {
            throw new ServiceException("The \"" + editedPayload + "\" cannot" 
        ...
        if (editedJobTitle == null) {
            throw new ServiceException("The \"" + editedPayload + "\" cannot " 
                    + "be updated, because the skill with \'" + editedPayload 
        ...
        try {
            ...
            throw new ServiceException("The \"" + editedJobTitle + "\" cannot " 
    ...
    public void delete(int id) {
        ...
        try {
            ...
            throw new ServiceException("The \'" + deletedJobTitle + "\' cannot" 
